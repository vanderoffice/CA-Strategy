...
This folder contains the core strategy documents for California Enterprise Modernization.

## Recommended Reading Order

| # | Document | Description |
|---|----------|-------------|
| 1 | [Executive Summary](executive-summary.md) | Start here. Overview, budget, timeline, recommended actions |
...
- [Operational Guides](../appendices/operational-guides.md) — Program frameworks and benchmarking
- [Technical Standards](../appendices/technical-standards.md) — Architecture and security standards
- [Budget Models](../appendices/budget-models.md) — Financial projections and change management
