...
- [Appendix B: Operational Guides](#appendix-b-operational-guides)
  - [B.1 Rapid RFI² Operational Guide](#b1-rapid-rfi-operational-guide)
  - [B.2 Fellowship Program Curriculum](#b2-fellowship-program-curriculum)
  - [B.3 Breakthrough Fund Sustainability Model](#b3-breakthrough-fund-sustainability-model)
  - [B.4 Labor Relations Strategy](#b4-labor-relations-strategy)
  - [B.5 Citizen Journey Teams Operating Guide](#b5-citizen-journey-teams-operating-guide)

---

> **Appendix Summary:** This appendix contains five operational guides: the Rapid RFI² process guide (B.1), Fellowship program curriculum (B.2), Breakthrough Fund sustainability model (B.3), labor relations strategy (B.4), and Citizen Journey Teams operating guide (B.5).

---

### B.1 Rapid RFI² Operational Guide

This appendix provides detailed operational guidance for executing Rapid RFI² challenges. For the strategic overview, see [Section 8.4: Rapid RFI²](./05-procurement-guide.md#84-rapid-rfi-challenge-based-procurement).
...
### B.2 Fellowship Program Curriculum
...
This appendix provides a detailed worked example of how the Breakthrough Fund sustainability model operates. For the strategic overview, see [Section 6.4: Sustainability Mechanism](./04-funding-implementation.md#64-sustainability-mechanism).
...
## B.5: Citizen Journey Teams Operating Guide

> **Guide Purpose:** Provides framework for organizing cross-agency teams around citizen life events, enabling seamless integrated services that transcend traditional agency boundaries.
...
| Executive Draft v1.0 | December 2025 | Initial executive draft with operational guides B.1-B.4 | Brent Vanderburgh |
...
*End of California Enterprise Modernization Plan - Operational Guides*
