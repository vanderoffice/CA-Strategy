...
- **Board Composition:** Appointments from Governor, Legislature, Judicial Council, Constitutional Officers, public members, and digital industry representatives ensuring cross-branch legitimacy
...
### ODI's Critical Role in This Plan

**Current ODI Functions:**
- Data and Innovation Fund (DIF) supporting department-level transformation projects
- CalAcademy providing training in human-centered design, data, and innovation practices
- CalInnovate advancing service design and user research
...
- **Leadership by domain experts** utilizing Supervising Engineer, Supervising Geologist, Environmental Program Manager, or equivalent classifications capable of managing Senior-level technical specialists
- **Blended expertise model** integrating licensed professionals (Engineers, Geologists, Environmental Scientists) with dedicated data professionals (Research Data Specialists at senior/supervisory levels)
- **Science classifications in leadership** provide higher compensation, strong critical thinking skills, and data expertise requisite to scientific practice
...
**Seed Investment:**
- 50/50 partnership between State of California and private sector partners
- Combined initial fund: $100 million total ($50M state, $50M private)
- State separately funds all permanent positions through ongoing General Fund contributions
...
- **Fixed 25%** of released funding diverted into Breakthrough Fund
- Remainder (75%) returns to General Fund, providing both fiscal benefit and replenished modernization pool

**Portfolio Reporting:**
- ODI manages fund using private-sector portfolio approach
- Annual "Modernization Portfolio Report" showing deployed capital, realized savings, key wins, and reusable components
...
The assessment informs every phase of the modernization plan:

- **E3 Deployment Prioritization:** Tier 1 departments receive Chief Deputy Directors first, creating early wins and demonstrating value
- **Fellowship Placements:** Fellows embedded in Tier 1-2 departments where they can succeed; Tier 3-4 departments receive capacity-building support first
- **Breakthrough Fund Allocation:** Projects from Tier 1 departments prioritized for funding; Tier 2-3 departments receive conditional funding with capability-building requirements
- **Data Governance Team Deployment:** Pilot teams deployed to Tier 1 departments to establish models; lessons learned inform Tier 2-3 deployments
...
- Breakthrough Fund demonstrating portfolio ROI and sustainable reinvestment model
...
| **Resistance to change** | HIGH | Innovation Ambassadors, protected learning time, no-blame experimentation zones, union engagement, quick wins demonstrating value, Readiness Assessment identifying and addressing concerns |
