...
- Provides centralized coordination, portfolio management, performance tracking, and support services
...
- **CDT** provides technology standards, cybersecurity guidance, cloud infrastructure, and enterprise architecture services
- **ODI** provides innovation methods, human-centered design, CalAcademy training, and DIF funding partnerships
- **CalHR** provides workforce planning, classification support for data governance teams, and change management guidance
- **DGS** supports procurement innovation, modular contracting, and facilities management
...
For complete team structure, operating procedures, success metrics, and priority journeys, see [Appendix B.5: Citizen Journey Teams Operating Guide](appendices/07-operational-guides.md#b5-citizen-journey-teams-operating-guide).

### 4.3 Procurement Integration

Product-led delivery requires procurement that moves at the speed of product development. California would integrate contracting directly into the Product Delivery Lifecycle through Enterprise Vendor Pools, modular contracting ($15M cap), and Rapid RFI² challenge-based procurement for innovation.

For comprehensive procurement framework including vendor pool structure, delegated ordering authority, and stage-gate integration, see [Procurement Guide Section 8](05-procurement-guide.md#8-procurement-innovation).
